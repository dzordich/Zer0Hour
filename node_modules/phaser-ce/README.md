...
```html
<script src="//cdn.jsdelivr.net/npm/phaser-ce@2.13.1/build/phaser.js"></script>
```

or the minified version:

```html
<script src="//cdn.jsdelivr.net/npm/phaser-ce@2.13.1"></script>
```

[Custom builds](https://cdn.jsdelivr.net/npm/phaser-ce@2.13.1/build/custom/) are available too.
