...
Exiled.Preload.prototype = {
    preload: function() {
        ...
        this.load.spritesheet('playership', 'static/assets/images/CandycePlayerSprite.png', 32, 32);
        ...
        this.load.audio('collect', 'static/assets/audio/collect.oog');
        this.load.audio('explosion', 'static/asssets/audio/explosion.oog');
